...
def create_app() -> FastAPI:
    ...
    async def matches_today() -> MatchListResponse:
    ...
    async def matches_upcoming(limit: int = 20) -> MatchListResponse:
    ...
    async def match_detail(match_id: str) -> MatchDetailResponse:
    ...
    async def match_prediction(match_id: str) -> MatchPredictionResponse:
    ...
    async def team_profile(team_id: str) -> TeamProfileResponse:
